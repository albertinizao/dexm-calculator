  var  heroe=0; var  norna=0; var  alfar=0; var  valkiria=0; var  risa=0; var  dvergr=0; var  fisico=0; var  agilidad=0; var  percepcion=0; var 
            ...
            function obtenerHabilidades(){
                limpiarHabilidades();
                document.getElementById("TituloListadoHabildiades").innerHTML="Habilidades aprendidas con el nuevo nivel";

                fetch('https://albertinizao.github.io/dexm-calculator/CompendioHabilidadesExport.json')
                    .then((response) => response.json())
                    .then((json) => json.forEach((element) => {
                        aprenderHabilidadComprobar(element.Nombre, element.Unica, element);
                    }));
            }