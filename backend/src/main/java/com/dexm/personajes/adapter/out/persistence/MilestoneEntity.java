...
@Entity @Table(name="character_milestones") public class MilestoneEntity {
 @Id private String id; private String characterId; private int level; private int experience; @Column(columnDefinition="text") private String snapshotJson; @Column(columnDefinition="text") private String newBonusesJson; @Column(columnDefinition="text") private String newAbilitiesJson; @Column(nullable=false) private boolean visible; private Instant createdAt;
