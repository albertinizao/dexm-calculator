...
public class WeaponCatalogService {
    ...
    private List<String> compatibleSizes(String slot) { String normalized = slot.trim().toUpperCase(Locale.ROOT); return switch (normalized) { case "SMALL_1", "SMALL_2", "SMALL_3" -> List.of("PEQUENA"); case "MEDIUM_1", "MEDIUM_2" -> List.of("PEQUENA", "MEDIANA"); case "ANY" -> List.of("PEQUENA", "MEDIANA", "GRANDE", "ENORME"); default -> throw new IllegalArgumentException("Hueco no válido"); }; }
